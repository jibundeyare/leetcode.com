# [Maximum Total Subarray Value I - LeetCode](https://leetcode.com/problems/maximum-total-subarray-value-i/description/?envType=daily-question&envId=2026-06-09)
...
for data in datas:
    result = solution.maxTotalValue(**data)
    print(f'{data=}')
    print(f'{result=}')
    print()
